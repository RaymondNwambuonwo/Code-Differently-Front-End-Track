...
Now that you are familiar with the basics of JavaScript, head on over to the [Lab](../Labs/js-basics-drill.md) to practice these new skills. Please use this lesson as a reference point if you find yourself having trouble.
